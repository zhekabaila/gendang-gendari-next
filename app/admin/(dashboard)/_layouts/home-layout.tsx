      ...
      <div className="max-w-7xl mx-auto px-8 py-12 mt-20">
        ...
        <div className="grid grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-purple-500">
            ...
            <div className="text-3xl mb-1">{loadingDashboardStats ? '...' : dashboardStats.totalTiket}</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-indigo-500">
            ...
            <div className="text-3xl mb-1">{loadingDashboardStats ? '...' : `Rp ${dashboardStats.totalPendapatan}`}</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-orange-500">
            ...
            <div className="text-3xl mb-1">{loadingDashboardStats ? '...' : dashboardStats.totalBlog}</div>
