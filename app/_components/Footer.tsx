...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-blue-900 via-indigo-900 to-pink-900 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          {/* Brand Section */}
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-400 to-indigo-400 rounded-xl md:rounded-2xl flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Beranda', 'Tentang', 'Blog', 'Kontak'].map((item) => {
                ...
                return (
                  <li key={item}>
                    <button className="text-blue-200 hover:text-white transition-colors">{item}</button>
                  </li>
                )
              })}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-start gap-2 md:gap-3">
                <Mail className="w-4 h-4 md:w-5 md:h-5 mt-0.5 text-blue-300" />
                <span className="text-blue-200 text-sm md:text-base">info@senilokal.id</span>
              </li>
              <li className="flex items-start gap-2 md:gap-3">
                <Phone className="w-4 h-4 md:w-5 md:h-5 mt-0.5 text-blue-300" />
                <span className="text-blue-200 text-sm md:text-base">+62 812 3456 7890</span>
              </li>
              <li className="flex items-start gap-2 md:gap-3">
                <MapPin className="w-4 h-4 md:w-5 md:h-5 mt-0.5 text-blue-300" />
        ...
        <div className="border-t border-blue-700 mt-8 md:mt-12 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-blue-300 text-xs md:text-sm text-center md:text-left">
            © 2025 SeniLokal. Semua hak cipta dilindungi.
          </p>
          <div className="flex gap-4 md:gap-6 text-blue-300 text-xs md:text-sm">
